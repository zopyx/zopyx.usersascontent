...
class IUsersAsContentSettings(Interface):
    ...
    redirect_after_registration = schema.Bool(title=_('Redirect to user object after registration (first login)'),
                          description=None,
                          default=True,
                          required=False)

    redirect_always = schema.Bool(title=_('Redirect to user object always after login'),
                          description=None,
                          default=True,
                          required=False)
