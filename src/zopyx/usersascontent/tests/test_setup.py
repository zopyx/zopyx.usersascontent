...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.isProductInstalled("zopyx.usersascontent"))

    def test_browserlayer(self):
        """Test that IZopyxUsersascontentLayer is registered."""
        from zopyx.usersascontent.interfaces import IZopyxUsersascontentLayer
        from plone.browserlayer import utils

        self.assertIn(IZopyxUsersascontentLayer, utils.registered_layers())
...
class TestUninstall(unittest.TestCase):
    ...
    def test_product_uninstalled(self):
        ...
        self.assertFalse(self.installer.isProductInstalled("zopyx.usersascontent"))
    ...
    def test_browserlayer_removed(self):
        ...
        self.assertNotIn(IZopyxUsersascontentLayer, utils.registered_layers())
